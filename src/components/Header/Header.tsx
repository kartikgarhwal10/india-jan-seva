...
export default function Header({ whatsAppNumber = SITE_CONFIG.whatsAppNumber }: HeaderProps) {
  ...
  const whatsAppLink = whatsAppNumber === SITE_CONFIG.whatsAppNumber 
    ? SITE_CONFIG.getWhatsAppProductLink("PVC Card") 
    : `https://wa.me/${whatsAppNumber}?text=${encodeURIComponent("Hello Unique Computer Centre, mujhe PVC Card ke baare mein information chahiye.")}`;
      ...
      <div className={styles.container}>
        <Link href="/" className={styles.logoArea}>
          ...
          <div className={styles.logoText}>
            <span className={styles.brandTitle}>Unique Computer Centre</span>
