...
export const metadata = {
  title: "CSC Services | Unique Computer Centre - CSC Point",
  description: "Browse official government Common Services Centre (CSC) facilitation services including Aadhaar prints, Ayushman Golden Cards, and PM-Kisan eKYC.",
};

export default function CscServices() {
  const cscServices = services.filter((s) => s.category === "csc");
    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <main className={styles.wrapper}>
        ...
        <section className={styles.hero}>
          <h1 className={styles.heroTitle}>CSC Services</h1>
          <p className={styles.heroSubtitle}>
            Official government-to-citizen digital assistance services processed directly at our Jarwal Road centre.
          </p>
        </section>
              ...
              <div key={service.id} className={styles.serviceCard}>
                ...
                <div className={styles.cardFooter}>
                  ...
                  <div style={{ display: "flex", gap: "0.75rem", alignItems: "center" }}>
                    ...
                    <a
                      href={`https://wa.me/917084666326?text=Hello%20Unique%20Computer%20Centre,%20mujhe%20${encodeURIComponent(service.name)}%20CSC%20service%20ke%20liye%20apply%20karna%20hai.`}
                      target="_blank"
                      rel="noopener noreferrer"
